...
| `FRONTEND_URL` | flat Django setting | `""` | Base URL for the invitation link (`{FRONTEND_URL}/invite/{token}` — the canonical frontend invite route) in the invite notification (`services._send_invitation_notification`) |
